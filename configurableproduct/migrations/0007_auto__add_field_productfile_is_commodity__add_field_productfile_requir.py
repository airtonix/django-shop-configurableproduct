...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductFile.is_commodity'
        db.add_column(u'configurableproduct_productfile', 'is_commodity',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProductFile.requires_license_key'
        db.add_column(u'configurableproduct_productfile', 'requires_license_key',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductFile.is_commodity'
        db.delete_column(u'configurableproduct_productfile', 'is_commodity')

        # Deleting field 'ProductFile.requires_license_key'
        db.delete_column(u'configurableproduct_productfile', 'requires_license_key')
    ...
    models = {
        ...
        'configurableproduct.productfile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_commodity': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['configurableproduct.CProduct']"}),
            'requires_license_key': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'system': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
