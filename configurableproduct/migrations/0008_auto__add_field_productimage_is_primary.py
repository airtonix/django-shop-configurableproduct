...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductImage.is_primary'
        db.add_column(u'configurableproduct_productimage', 'is_primary',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductImage.is_primary'
        db.delete_column(u'configurableproduct_productimage', 'is_primary')
